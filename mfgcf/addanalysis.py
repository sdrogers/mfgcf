...
GCF_TYPES = ['allRiPPs','allPKSother','allOthers','allNRPS','allPKSI','allPKS-NRP-Hybrids','allSaccharides','allTerpene']
GCF_TYPES2 = ['All_RiPPs','All_PKSother','All_Others','All_NRPS','All_PKSI','All_PKS-NRP-Hybrids','All_Saccharides','All_Terpene']
